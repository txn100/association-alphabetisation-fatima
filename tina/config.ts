    ...
    collections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "category", label: "Catégorie", required: true, options: ["Éco-responsable", "Infrastructure", "Communautaire"] },
          { type: "string", name: "status", label: "Statut", required: true, options: [{ value: "completed", label: "Terminé" }, { value: "in-progress", label: "En cours" }, { value: "planned", label: "Planifié" }] },
          { type: "string", name: "description", label: "Description", required: true, ui: { component: "textarea" } },
          { type: "image", name: "image", label: "Image principale", required: true },
          { type: "string", name: "imageAlt", label: "Texte alternatif de l'image", required: true },
          { type: "string", name: "completionDate", label: "Date de réalisation", description: "Ex: Mars 2025" },
          { type: "string", name: "beneficiaries", label: "Bénéficiaires", description: "Ex: 350 élèves" },
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "phone1", label: "Téléphone 1 (fixe)" },
          { type: "string", name: "phone1Link", label: "Lien tel 1 (ex: +2302613032)" },
          { type: "string", name: "phone2", label: "Téléphone 2 (fixe)" },
          { type: "string", name: "phone2Link", label: "Lien tel 2 (ex: +2302616719)" },
          { type: "string", name: "phone3", label: "Téléphone 3 (mobile/WhatsApp)" },
          { type: "string", name: "phone3Link", label: "Lien tel 3 (ex: +23059855253)" },
          { type: "string", name: "email", label: "Email" },
          { type: "string", name: "whatsappNumber", label: "Numéro WhatsApp (format: 23059855253)" },
        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "accountNumberPrivate", label: "N° compte Particulier" },
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "contactPhone", label: "Téléphone du contact" },
